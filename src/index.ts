...
if (newTask) {
  const completedBeforeDeadline = taskController.isTaskCompletedBeforeDeadline(newTask.id);
...
const bug1 = new Bug({ id: "2", title: "Login error" }, "critical");

const epic = new Epic(
  { id: "100", title: "Frontend Release" },
  [task1, bug1]
);
